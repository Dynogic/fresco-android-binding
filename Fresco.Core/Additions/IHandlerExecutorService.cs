...
namespace Com.Facebook.Common.Executors
{
    ...
    public partial interface IHandlerExecutorService : global::Java.Util.Concurrent.IScheduledExecutorService
    {
        ...
        bool IsHandlerThread
        {
            ...
            [Register("isHandlerThread", "()Z", "GetIsHandlerThreadHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, Fresco.Core")]
            get;
        }
        ...
        [Register("quit", "()V", "GetQuitHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, Fresco.Core")]
        void Quit();
...
#pragma warning restore 0169
        ...
        IList<IRunnable> IExecutorService.ShutdownNow()
        {
